...
This section contains two parts (i) ETL using Python (ii) Data Pipeline using Apache Airflow

## ETL using Python

The Data Warehouse gets information from several sources including the transactional (OLTP) database. Transactional data from the OLTP database (in this case MySQL) needs to be propagated to the Warehouse on frequent basis. 
...
[automation.py](https://github.com/smitshah1920/IBM-Data-Engineering/blob/main/Course-13-%20DE%20Capstone%20Project/C13W5/Assignment%201%262/Assignment%20-%20ETL/automation.py))

## Datapipeline using Apache Airflow
...
[process_web_log.py](https://github.com/smitshah1920/IBM-Data-Engineering/blob/main/Course-13-%20DE%20Capstone%20Project/C13W5/Assignment%201%262/Assignment-%20Datapipelines%20using%20Apache%20Airflow/process_web_log.py)

The following Screenshot shows DAG Run
![image](https://github.com/smitshah1920/IBM-Data-Engineering/assets/116938231/2d729824-6eea-42fa-9b0e-e98db96341e3)
